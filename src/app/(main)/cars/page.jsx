...
export async function generateMetadata({ searchParams }) {
  ...
  const description = facetKey
    ...
    : "منصتكم الموثوقة لشراء السيارات الجديدة والمستعملة في المملكة العربية السعودية. تصفّح تشكيلة واسعة من كبرى العلامات التجارية مع عروض حصرية وحلول تمويلية ميسّرة.";
