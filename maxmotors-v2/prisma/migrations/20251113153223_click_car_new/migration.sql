...
CREATE TABLE "DealershipInfo" (
    ...
    "email" TEXT NOT NULL DEFAULT 'contact@clickcar.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ChatLog" (
    ...
    "carsFound" INTEGER NOT NULL DEFAULT 0,
    "carsShown" INTEGER NOT NULL DEFAULT 0,
    "carIds" TEXT[],
...
CREATE TABLE "FeaturedModel" (
    ...
    CONSTRAINT "FeaturedModel_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "ChatLog_language_idx" ON "ChatLog"("language");

-- CreateIndex
CREATE INDEX "FeaturedBrand_order_idx" ON "FeaturedBrand"("order");

-- CreateIndex
CREATE INDEX "FeaturedBrand_isActive_idx" ON "FeaturedBrand"("isActive");

-- CreateIndex
CREATE INDEX "FeaturedModel_order_idx" ON "FeaturedModel"("order");

-- CreateIndex
CREATE INDEX "FeaturedModel_isActive_idx" ON "FeaturedModel"("isActive");
